    ...
    <div className="min-h-screen bg-brand-gradient flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-xl border border-primary/20 bg-card/40 backdrop-blur p-8 shadow-lg">
          ...
          <div
            className="relative text-center w-full px-4 py-2.5 items-center rounded-lg bg-primary hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition-all"
          >
